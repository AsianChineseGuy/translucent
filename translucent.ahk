...
; Launch firefox & cmd with winkey + w | winkey + t
#w::run, "C:\Program Files\Mozilla Firefox\firefox.exe"
#t::run, "C:\Users\username\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\System Tools\Command Prompt"
...
; Map esc to enter
Esc::Enter
; Maps pausebreak to ctrl + alt + x 
Pause::Send ^!{x}


; Switch window to left or right monitor
; alt + q | alt + e
!q::Send #+{left}         
!e::Send #+{right}       

; alt + w set to maximise | alt + s minimize window
!w::Send #{up}          
!s::Send #{down}       
...
;;; Virtual desktop speed swapping
; Globals
